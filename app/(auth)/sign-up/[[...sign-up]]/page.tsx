      ...
      <SignUp.Root>
        ...
        >
          <header className="flex flex-col items-center gap-2">
            ...
            <h1 className="text-2xl font-bold tracking-wide text-black uppercase">CodeBox</h1>
            <p className="text-xs text-black/60 uppercase tracking-widest">Create your account</p>
          </header>
          ...
          <div className="space-y-4">
            <Clerk.Field name="emailAddress" className="space-y-1">
              <Clerk.Label className="block font-bold text-black uppercase text-xs tracking-widest">Email</Clerk.Label>
              <Clerk.Input
                type="email"
                required
            ...
            <Clerk.Field name="password" className="space-y-1">
              <Clerk.Label className="block font-bold text-black uppercase text-xs tracking-widest">Password</Clerk.Label>
              <Clerk.Input
                type="password"
                required
                placeholder="••••••••"
          ...
          <p className="text-center text-xs text-black/60 uppercase">
            ...
            <Clerk.Link navigate="sign-in" className="font-bold text-black underline underline-offset-2 hover:text-yellow-600">
              Sign in
            </Clerk.Link>
          </p>
        </SignUp.Step>
        ...
        >
          <header className="flex flex-col items-center gap-2">
            <Image src="/logo.png" alt="CodeBox logo" width={48} height={48} />
            <h1 className="text-2xl font-bold tracking-wide text-black uppercase">CodeBox</h1>
            <p className="text-xs text-black/60 uppercase tracking-widest">Check your inbox</p>
          </header>
          ...
          <SignUp.Strategy name="email_code">
            <Clerk.Field name="code" className="space-y-1">
              <Clerk.Label className="block font-bold text-black uppercase text-xs tracking-widest">Verification Code</Clerk.Label>
              <Clerk.Input
                type="otp"
                required
                placeholder="000000"
                className="w-full px-3 py-2 bg-white border-2 border-black shadow-[3px_3px_0_0_#000] outline-none focus:border-yellow-400 focus:shadow-[3px_3px_0_0_#fbbf24] placeholder:text-black/30 transition-all tracking-widest text-center"
              />
              <Clerk.FieldError className="text-xs text-red-500 font-bold" />
            </Clerk.Field>
            ...
            <SignUp.Action
              submit
              className="w-full mt-4 px-4 py-2 bg-yellow-400 border-2 border-black shadow-[4px_4px_0_0_#000] active:translate-y-[2px] active:shadow-none text-black font-bold uppercase hover:bg-yellow-300 transition-colors"
            >
              Verify Email
            </SignUp.Action>
          </SignUp.Strategy>
        ...
        >
          <header className="flex flex-col items-center gap-2">
            <Image src="/logo.png" alt="CodeBox logo" width={48} height={48} />
            <h1 className="text-2xl font-bold tracking-wide text-black uppercase">CodeBox</h1>
            <p className="text-xs text-black/60 uppercase tracking-widest">Almost there!</p>
          </header>

          <Clerk.GlobalError className="block text-sm text-red-500 font-bold" />

          <Clerk.Field name="username" className="space-y-1">
            <Clerk.Label className="block font-bold text-black uppercase text-xs tracking-widest">Username</Clerk.Label>
            <Clerk.Input
              type="text"
              required
